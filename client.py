...
def createTicket():
    global gameWindow
    global ticketGrid
    mainLabel = Label(gameWindow, width=65, height=15, releif="ridge", borderwidth=5, bg="white")
    ...
    for row in range(0, 3):
        ...
        for col in range(0, 9):
            if (platform.system() == "Darwin"):
                boxButton = Button(gameWindow, font = "Chalkboard SE 18", borderwidth = 3,pady = 23, padx = 22, bg = '#fff176', highlightbackground="#fff176", activebackground="#c501a5" )
